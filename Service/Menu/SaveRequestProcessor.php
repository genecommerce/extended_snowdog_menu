...
namespace Gene\ExtendedSnowdogMenu\Service\Menu;
...
class SaveRequestProcessor extends \Snowdog\Menu\Service\Menu\SaveRequestProcessor
{
    /**
    ...
    /**
     * SaveRequestProcessor constructor.
    ...
    public function __construct(
        ...
        parent::__construct($messageManager, $nodeRepository, $nodeImageFile, $imageNode, $nodeValidator, $nodeFactory, $menuNodes);
    ...
    /**
     * @param NodeInterface $nodeObject
    ...
    private function processNodeObject(
        ...
        if (isset($nodeData['font_color'])) {
            $nodeObject->setFontColor($nodeData['font_color']);
        }

        if (isset($nodeData['font_weight'])) {
            $nodeObject->setFontWeight($nodeData['font_weight']);
        }
